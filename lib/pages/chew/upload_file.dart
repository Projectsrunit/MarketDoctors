...
class ChewUploadCredentialsPage extends StatefulWidget {
  const ChewUploadCredentialsPage({super.key});

  @override
  _ChewUploadCredentialsPageState createState() =>
      _ChewUploadCredentialsPageState();
}

class _ChewUploadCredentialsPageState extends State<ChewUploadCredentialsPage> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    const Text(
                      'Upload a certifying document as a CHEW. Your data will be kept safe and private.',

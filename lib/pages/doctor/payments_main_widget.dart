...
class DoctorPaymentsMainWidget extends StatefulWidget {
  @override
  DoctorPaymentsMainWidgetState createState() => DoctorPaymentsMainWidgetState();
}

class DoctorPaymentsMainWidgetState extends State<DoctorPaymentsMainWidget> {
